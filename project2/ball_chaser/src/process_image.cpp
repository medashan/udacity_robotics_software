...
// Define global vector of robot last position, moving state of the robot, and the client that can request services
std::vector<float> robots_last_position{ 0.0, 0.0 };
